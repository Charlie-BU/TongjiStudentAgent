...
func TestMCPToolAllowlist(t *testing.T) {
	Convey("聊天服务的远程 MCP Tool 白名单", t, func() {
		...
		expectedTools := []string{
			toolallowlist.TongjiUserAnnualBillTool,
			toolallowlist.TongjiUserCardSpendingFlowTool,
			toolallowlist.TongjiStudentTimetableTool,
			toolallowlist.TongjiStudentDetailedInfoTool,
			toolallowlist.TongjiBachelorScoreTool,
			toolallowlist.TongjiUserTermCalendarTool,
			toolallowlist.TongjiUserCurrentTermCalendarTool,
			toolallowlist.TongjiCETScoreTool,
			toolallowlist.TongjiUserBookLendInfoTool,
			toolallowlist.TongjiUserStatisticsInfoTool,
			toolallowlist.TongjiStipendInfoTool,
			toolallowlist.TongjiAccommodationInfoTool,
			toolallowlist.TongjiBachelorCompetitionPrizeTool,
			toolallowlist.TongjiHonoraryTitleTool,
			toolallowlist.TongjiScholarshipInfoTool,
			toolallowlist.TongjiUserSchoolAccessTool,
			toolallowlist.TongjiUserLibraryAccessTool,
			toolallowlist.TongjiPostgraduateGPATool,
			toolallowlist.TongjiPostgraduateRequiredCreditTool,
			toolallowlist.TongjiUserResearchProjectsTool,
			toolallowlist.TongjiUserResearchWorksTool,
			toolallowlist.TongjiUserContactInfoTool,
			toolallowlist.TongjiUserUpdateContactInfoTool,
			toolallowlist.TongjiStudentHardshipAllowanceTool,
			toolallowlist.TongjiStudentLoanTool,
			toolallowlist.TongjiStudentWorkStudyTool,
			toolallowlist.TongjiTeacherTimetableTool,
			toolallowlist.TongjiUserCardBalanceTool,
			toolallowlist.TongjiPostgraduatePlanProgressTool,
			toolallowlist.TongjiPostgraduatePlanTool,
			toolallowlist.TongjiPostgraduateMajorsTool,
			toolallowlist.TongjiPostgraduateScoreTool,
			toolallowlist.TongjiUserResearchPatentsTool,
			toolallowlist.TongjiStudentFinalExamsTool,
			toolallowlist.TongjiStudentDeferredExamsTool,
			toolallowlist.TongjiBachelorGradeSummaryTool,
			toolallowlist.TongjiUserEmailTool,
			toolallowlist.TongjiTeacherTitleTool,
			toolallowlist.TongjiStudentCounselorTool,
			toolallowlist.TongjiPostgraduateCompletedCreditTool,
			toolallowlist.TongjiPostgraduateDegreeCreditTool,
			toolallowlist.TongjiPostgraduateDegreeAverageTool,
